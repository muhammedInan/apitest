 ...
 * @UniqueEntity(
 *      fields={"libelle"},
 *      message="il existe deja un genre avec le libelle {{ value }}, veuillez saisir un autre libellé"
 * )
 */
class Genre
{
  ...
  //    normalizationContext={             alternative pour normalize au dessus de la classe genre
